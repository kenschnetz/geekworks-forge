<?php
    ...
    use App\Models\Tag as TagsModel;

    class Tags extends ItemList {
        public string $sort_field = 'name', $item_icon = 'fa-hashtag', $item_name = 'Tag', $route = 'admin-tag';
        ...
        private function GetItems() {
            return TagsModel::orderBy($this->sort_field, $this->sort_direction)
