<div class="sticky bottom-0 p-4 text-center lg:text-right">
    <a href="{{ route('messenger') }}" x-on:click="chat_open = true" class="relative bg-purple-800 hover:bg-transparent text-white hover:text-purple-800 font-bold px-4 py-3 border border-purple-800 shadow-lg mr-3">
