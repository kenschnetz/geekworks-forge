<div class="mt-12">
    ...
    <div class="mt-12 rounded-lg p-6 bg-white dark:bg-zinc-700" x-data="{ show_advanced_options: false }" x-cloak>
        ...
        <input wire:model="post_details.title" class="mt-3 w-full px-4 py-3 border border-purple-700 focus:outline-none focus:border-purple-700" placeholder="Post title" />
        ...
        <input wire:model="post_details.description" class="mt-3 w-full px-4 py-3 border border-purple-700 focus:outline-none focus:border-purple-700" placeholder="Post description" />
        ...
        <div class="mt-3 w-full text-right">
            <button wire:click="CreatePost()" class="mt-1 bg-purple-700 hover:bg-transparent text-white hover:text-purple-700 font-bold px-4 py-3 border border-purple-700">
                Create Post
            </button>
        </div>
        <hr class="my-3" />
