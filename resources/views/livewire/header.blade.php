    ...
    <div class="max-w-2xl mx-auto p-4 lg:max-w-7xl">
        <div class="relative flex justify-between">
            ...
            <div class="hidden lg:flex-1 lg:flex lg:items-center lg:justify-center">
                <a href="{{ route('post-search') }}" class="inline-flex items-center justify-center px-4 py-2 border border-transparent font-bold text-sm shadow-sm text-white bg-purple-700 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:purple-700 uppercase" style="width: 150px">
                    Search
                </a>
        ...
        <div class="mt-3 lg:hidden flex">
            <a href="{{ route('post-search') }}" class="flex-1 p-4 flex align-middle justify-center border border-transparent font-bold text-sm shadow-sm text-white bg-purple-700 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:purple-700 uppercase">
                Search
            </a>
