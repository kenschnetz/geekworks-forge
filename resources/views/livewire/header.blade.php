<header class="bg-white shadow-sm" x-data="{ mobile_menu_open: false, profile_menu_open: false }">
    <div class="max-w-7xl mx-auto px-4">
        <div class="relative flex justify-between py-6">
            ...
            <div class="hidden lg:flex lg:items-center lg:justify-end">
                ...
                <a href="{{ route('new-post') }}" class="ml-6 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                    New Post
                </a>
            </div>
        </div>
    ...
    <div x-show="mobile_menu_open">
        ...
        <hr />
        <x-profile-menu class="py-5 font-semibold text-gray-500 uppercase tracking-wider align-middle"></x-profile-menu>
    </div>
</header>
