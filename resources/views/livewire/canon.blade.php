<x-layout.editable.left-sidebar.above-on-mobile :editing="$editing">
    ...
    <div class="bg-white p-4 shadow" x-data="{ name: @entangle('item.name'), description: @entangle('item.description'), limit: 255 }" x-cloak>
        @if($editing)
            ...
            <div class="mt-3 w-full">
                <div class="relative inline-block mr-4 align-middle select-none transition duration-200 ease-in">
                    <input wire:model="item.publicly_visible" type="checkbox" name="public" id="public" class="text-purple-800 focus:ring-purple-800 toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"/>
            ...
            @if($item->publicly_visible)
                <div class="mt-3 w-full">
                    <div class="relative inline-block mr-4 align-middle select-none transition duration-200 ease-in">
                        <input wire:model="item.allow_collaboration" type="checkbox" name="public" id="public" class="text-purple-800 focus:ring-purple-800 toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"/>
                        <label for="toggle" class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300 cursor-pointer"></label>
                    </div>
                    <div class="relative inline-block ml-4">
                ...
                @if($item->allow_collaboration)
                    <div class="mt-3 w-full">
                        <div class="relative inline-block mr-4 align-middle select-none transition duration-200 ease-in">
                            <input wire:model="item.require_approval" type="checkbox" name="public" id="public" class="text-purple-800 focus:ring-purple-800 toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"/>
                            <label for="toggle" class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300 cursor-pointer"></label>
                        </div>
                        <div class="relative inline-block ml-4">
