<?php
    ...
    class CreateUserActivityPostCommentsTable extends Migration {
        /**
         * Run the migrations.
         *
         * @return void
         */
        public function up() {
            Schema::create('post_comment_activity', function (Blueprint $table) {
                $table->id();
                ...
                $table->unique(['user_activity_id', 'post_comment_id', 'date'], 'comment');
            });
        }
        ...
        public function down() {
            Schema::dropIfExists('user_activity_post_comments');
        }
    }
