        ...
        public function run() {
            DB::table('posts')->insert([
                [
                    ...
                    'system_id' => 2,
                    'category_id' => 2,
                    'slug' => 'forthin-ring-of-damaging-1',
                    'published' => true,
                    'moderated' => false,
            ...
            DB::table('post_details')->insert([
                [
                    ...
                    'content' => 'Forged in the depths of an active volcano, Forthin gives spellcasters the ability to strike their foes with additional damage multiple times per long rest.',
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
